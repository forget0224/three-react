...
function App() {
  useEffect(() => {
    ...
    // // Part 1
    const spaceTexture = new THREE.TextureLoader().load('img/assets/space.jpeg');
    ...
    // // Part 2
    const uvTexture = new THREE.TextureLoader().load('img/assets/uv.png');
    const crateTexture = new THREE.TextureLoader().load('img/assets/crate.png');
    const earthTexture = new THREE.TextureLoader().load('img/assets/earth.jpeg');
    const brickTexture = new THREE.TextureLoader().load('img/assets/brick.jpeg');
